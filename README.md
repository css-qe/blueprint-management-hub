...
```yaml
bases:
- git::https://github.com/css-qe/blueprint-management-hub.git//profiles/production.gcp/00_install-config
...
- [Management Hub cluster running on GCP](sites/edge-mgmt-hub.edge.css-qe.com/README.md)
