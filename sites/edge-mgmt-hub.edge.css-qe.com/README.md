...
`knictl fetch_requirements github.com/css-qe/blueprint-management-hub/sites/mgmt-edge-hub.gcp.devcluster.openshift.com/`
...
`knictl prepare_manifests edge-mgmt-hub.edge.css-qe.com`
...
`$HOME/.kni/edge-mgmt-hub.edge.css-qe.com/requirements/openshift-install create cluster --dir=$HOME/.kni/edge-mgmt-hub.edge.css-qe.com/final_manifests --log-level debug`
...
`knictl apply_workloads edge-mgmt-hub.edge.css-qe.com`
